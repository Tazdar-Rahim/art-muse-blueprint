  ...
  return (
    ...
    >
      ...
      <h1 className='2xl:text-7xl text-6xl px-8 font-semibold text-center tracking-tight leading-[120%]'>
        Farhana&apos;s Art Gallery <br /> Scroll to Explore 👇
      </h1>
    </motion.section>
  );
};
    ...
    >
      ...
      <article className='container mx-auto relative z-10'>
        <h1 className='text-6xl leading-[100%] py-10 font-semibold tracking-tight'>
          Artistic Creations <br /> that Inspire and Captivate
        </h1>
        <div className='grid grid-cols-4 gap-4'>
          ...
          />
          <img
            src='https://images.unsplash.com/photo-1578321272176-b7bbc0679853?w=500&auto=format&fit=crop'
            alt='Oil painting'
            className='object-cover w-full rounded-md'
          />
          <img
            src='https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=500&auto=format&fit=crop'
            alt='Watercolor artwork'
            className='object-cover w-full rounded-md h-full'
          />
          <img
            src='https://images.unsplash.com/photo-1578322450569-1fe7e0b8b91f?w=500&auto=format&fit=crop'
            alt='Digital art'
            className='object-cover w-full rounded-md h-full'
          />
        </div>
