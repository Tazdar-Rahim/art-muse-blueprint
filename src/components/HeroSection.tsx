        ...
        <div className="container mx-auto px-6 text-center z-10">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              ...
              medium: "Custom Commissions",
              color: "from-yellow-400 to-yellow-500"
            }].map(({
              medium,
              color
            }) => <Badge key={medium} className={`px-4 py-2 bg-gradient-to-r ${color} text-white border-0 shadow-crayon hover:scale-105 transition-transform duration-300 font-medium`}>
                  {medium}
                </Badge>)}
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Button size="lg" onClick={onExploreGallery} className="bg-gradient-primary hover:shadow-elegant hover:scale-105 transition-all duration-300 text-lg px-10 py-4 rounded-2xl shadow-soft border-0">
                View My Gallery
