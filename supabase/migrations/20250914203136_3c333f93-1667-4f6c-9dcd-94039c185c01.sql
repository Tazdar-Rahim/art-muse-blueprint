...
('Winter Bicycle Rest', 'An intimate moment of stillness as winter embraces everyday objects, transforming the ordinary into art', 'print', 'digital', 'contemporary', 475.00, '16x20 inches', ARRAY['/src/assets/artwork-12-winter-bicycle.jpg'], true, true),
...
('Evening Snow Magic', 'The magical transition from day to evening captured in soft snow and gentle light', 'print', 'digital', 'realism', 595.00, '18x24 inches', ARRAY['/src/assets/artwork-19-evening-snow.jpg'], true, true),

('Twilight Winter Glow', 'The enchanting glow of twilight over a winter landscape, where light and shadow dance in perfect harmony', 'print', 'digital', 'realism', 675.00, '20x30 inches', ARRAY['/src/assets/artwork-20-twilight-winter.jpg'], true, true);